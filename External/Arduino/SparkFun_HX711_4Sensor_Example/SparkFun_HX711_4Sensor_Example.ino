...
//#define calibration_factor -22700.0 //This value is obtained using the SparkFun_HX711_Calibration sketch
//-21350 for sensor 1
//-20850 for sensor 2
//-22700 for sensor 3 and 4
...
void loop() {
  ...
  Serial.print(scale_sensor1.get_units(), 1); //scale.get_units() returns a float
  Serial.print(" kg "); //You can change this to kg but you'll need to refactor the calibration_factor

  Serial.print("Sensor 2: ");
  Serial.print(scale_sensor2.get_units(), 1); //scale.get_units() returns a float
  Serial.print(" kg "); //You can change this to kg but you'll need to refactor the calibration_factor

  Serial.print("Sensor 3: ");
  Serial.print(scale_sensor3.get_units(), 1); //scale.get_units() returns a float
  Serial.print(" kg "); //You can change this to kg but you'll need to refactor the calibration_factor

  Serial.print("Sensor 4: ");
  Serial.print(scale_sensor4.get_units(), 1); //scale.get_units() returns a float
  Serial.print(" kg "); //You can change this to kg but you'll need to refactor the calibration_factor
  Serial.println();
}
